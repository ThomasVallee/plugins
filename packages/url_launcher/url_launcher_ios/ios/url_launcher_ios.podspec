...
A Flutter plugin for making the underlying platform (Android or iOS) launch a URL.
                       DESC
  s.homepage         = 'https://github.com/ThomasVallee/plugins/tree/main/packages/url_launcher'
  s.license          = { :type => 'BSD', :file => '../LICENSE' }
  s.author           = { 'Flutter Dev Team' => 'flutter-dev@googlegroups.com' }
  s.source           = { :http => 'https://github.com/ThomasVallee/plugins/tree/main/packages/url_launcher/url_launcher_ios' }
