...
Enables Google Sign-In in Flutter apps.
                       DESC
  s.homepage         = 'https://github.com/ThomasVallee/plugins/tree/main/packages/google_sign_in'
  s.license          = { :type => 'BSD', :file => '../LICENSE' }
  s.author           = { 'Flutter Team' => 'flutter-dev@googlegroups.com' }
  s.source           = { :http => 'https://github.com/ThomasVallee/plugins/tree/main/packages/google_sign_in/google_sign_in_ios' }
